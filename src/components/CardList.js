...
const generatorAddress = '0x5c23544683efe5d7811d51cac81573e3c989c211'
...
export default class CardList extends Component {
  ...
  render(){
    ...
    return (
      <div>
      <button className='button' onClick={() => this.state.generator.generateCard({value: web3.toWei(0.0001, 'ether'), gas: 500000})}>Get Random Card: 0.0001 <img style={{marginLeft: -5, marginBottom: -5, width:18,height:22}}src={require('../assets/ethereum.png')} /> </button>
